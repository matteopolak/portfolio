...
The production build also exercises the prerendered pages, sitemap and robots endpoints, and the release-backed Lodestone and Quasi asset synchronization used by `prebuild`.
